<template>
  <div
    class="bg-gray-800 text-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto mt-8"
  >
      ...
      <div v-if="results.length" class="space-y-6">
        ...
        >
          ...
          <ul class="list-none space-y-2">
            <li
              v-for="(value, key) in result.entries"
              :key="key"
        ...
        <button
          ...
          class="w-full px-6 py-2 mt-4 bg-blue-500 hover:bg-blue-600 rounded shadow"
        >
          Complete
        </button>
      </div>
